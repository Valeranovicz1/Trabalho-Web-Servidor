...
<main class="container">
    <div class="row justify-content-center">
        <div class="col-lg-8 sobre-container">
            ...
            <section class="mb-5">
                <h2>Missão</h2>
                <p>Nossa missão é transformar ideias criativas em jogos que inspirem, desafiem e divirtam. Buscamos constantemente superar os limites da tecnologia e da narrativa para proporcionar experiências inesquecíveis.</p>
            </section>
                ...
                <div class="accordion" id="valoresAccordion">
                    <div class="accordion-item border-0">
                        <h2 class="accordion-header" id="headingInovacao">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseInovacao" aria-expanded="false" aria-controls="collapseInovacao">
                                Inovação
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item border-0">
                        <h2 class="accordion-header" id="headingQualidade">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseQualidade" aria-expanded="false" aria-controls="collapseQualidade">
                                Qualidade
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item border-0">
                        <h2 class="accordion-header" id="headingPaixao">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePaixao" aria-expanded="false" aria-controls="collapsePaixao">
                                Paixão
                            </button>
                        </h2>
                    ...
                    <div class="accordion-item border-0">
                        <h2 class="accordion-header" id="headingCompromisso">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCompromisso" aria-expanded="false" aria-controls="collapseCompromisso">
